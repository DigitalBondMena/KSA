...
@Component({
  selector: 'app-enterpartener',
  templateUrl: './enterpartener.component.html',
  styleUrls: ['./enterpartener.component.css']
})
export class EnterpartenerComponent implements OnInit {
  ...
  showData(){
    ...
    this._Dashservice.getentrepreneurship().subscribe((res)=>{
  ...
  this._Dashservice.updateentrepreneurship(form , id ).subscribe(
    (res)=>{
