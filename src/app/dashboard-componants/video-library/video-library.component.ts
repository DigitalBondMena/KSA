...
export class VideoLibraryComponent implements OnInit {
  ...
  imageSrc='https://ksa-students.com/ksastudentsMopileApp/VideoControl/'
  ...
  ar_tag_title:  new FormControl( null),
  ar_tag_text:  new FormControl( null),
  ...
  getDataWithOutLoading(){
    //loading display
    this._Dashservice.getvideoLibrary().subscribe((res)=>{
  ...
  addData(form:any):any {
    if(this.newData.valid == true){
      ...
      this.formData.append('link' , this.newData.controls.link.value!)
      this.formData.append('status' , this.newData.controls.status.value!)
      ...
      this._Dashservice.addvideoLibrary(form).subscribe(
        (res)=>{
  ...
  showData(id:any){
    ...
    this._Dashservice.showvideoLibrary(id).subscribe((res)=>{
      this.ShowAarry = res.row


      this.newData.get('ar_title')?.setValue(this.ShowAarry?.ar_title)
      this.newData.get('link')?.setValue(this.ShowAarry?.link)
      this.newData.get('status')?.setValue(this.ShowAarry?.status)
  ...
  this._Dashservice.updatevideoLibrary(form , id ).subscribe(
    (res)=>{
  ...
  disabledData(id:any){
   this.loadingD=true
    ...
    this._Dashservice.disabledvideoLibrary(id).subscribe((res)=>{
      if (res.success != undefined) {
        this.loadingD=false
        this.deleteMSG = true
        $('.btn-close').click()
  ...
  this.loadingR=true
    ...
    //send id of product to api 
    this._Dashservice.recoveryvideoLibrary(id).subscribe((res)=>{
      if (res.success != undefined) {
        this.loadingR=false
...
emptyForm(){
  ...
  this.newData.get('link')?.setValue(null)
  this.newData.get('status')?.setValue('1')
  ...
  this.newData.controls.link.markAsUntouched()
  this.newData.controls.status.markAsUntouched()
...
requiredFrom(){
  ...
  this.newData.controls.link.markAsTouched()
  this.newData.controls.status.markAsTouched()
