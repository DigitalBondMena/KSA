...
@Component({
  selector: 'app-ksa-jobs',
  templateUrl: './ksa-jobs.component.html',
  styleUrls: ['./ksa-jobs.component.css']
})
export class KsaJobsComponent implements OnInit {
  ...
  getDataWithOutLoading(){
    //loading display
    this._Dashservice.getJobs().subscribe((res)=>{
  ...
  addData(form:any):any {
    if(this.newData.valid == true){
      ...
      this._Dashservice.addJobs(form).subscribe(
        (res)=>{
  ...
  showData(id:any){
    ...
    this._Dashservice.showJobs(id).subscribe((res)=>{
  ...
  this._Dashservice.updateJobs(form , id ).subscribe(
    (res)=>{
  ...
  disabledData(id:any){
   this.loadingD=true
    ...
    this._Dashservice.disabledJobs(id).subscribe((res)=>{
      if (res.success != undefined) {
        this.loadingD=false
        this.deleteMSG = true
        $('.btn-close').click()
  ...
  this.loadingR=true
    ...
    //send id of product to api 
    this._Dashservice.recoveryJobs(id).subscribe((res)=>{
      if (res.success != undefined) {
        this.loadingR=false
